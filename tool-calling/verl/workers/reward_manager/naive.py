...
class NaiveRewardManager:
    ...
    def __call__(self, data: DataProto, return_dict=False):
        ...
        for i in range(len(data)):
            ...
            # Copy to avoid mutating the dataset-provided extra_info dict in place.
            extra_info = dict(data_item.non_tensor_batch.get("extra_info", {}))
            num_turns = data_item.non_tensor_batch.get("__num_turns__", None)
            extra_info["num_turns"] = num_turns
            extra_info["step"] = data_item.meta_info.get("global_steps", 0)

            score, fomrat_score, correctness_score, length_score = self.compute_score(
            ...
            if isinstance(score, dict):
                ...
                reward_extra_info["format_score"].append(fomrat_score)
        ...
        if return_dict:
            ...
            return reward_tensor, format_tensor, correctness_tensor, length_tensor, reward_extra_info
